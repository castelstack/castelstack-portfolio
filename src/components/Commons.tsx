  ...
  <>
    {texts && (
      <div className="flex flex-col mb-2">
        <p className="text-sm text-gray-500 tracking-wide font-extralight capitalize">{title}</p>
        <p className="text-base text-text tracking-wide leading-7">{texts}</p>
      </div>
    )}
  </>
);
...
export const InfoOrgLayout = ({title, list}: {title: string; list: InfoImageProp[]}) => (
  <>
    {list?.length > 1 && (
      <div className="flex flex-col mb-2">
        <p className="text-sm text-gray-500 tracking-wide font-extralight capitalize my-2">
          {title}
        </p>
...
export const Github = () => {
  return (
    ...
    >
      <title>GitHub-Castelstack</title>
...
export const LinkedIn = () => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <title>LinkedIn-okafor_Henry</title>
...
export const Gmail = () => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <title>Gmail-Okaforhenry01</title>
